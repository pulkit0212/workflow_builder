  ...
  return (
    <div className="space-y-8">
      <SectionHeader
        ...
        description="Connect Google to pull upcoming meetings from Calendar and prepare the assistant for automatic meeting intake."
      />
        ...
        <div className="space-y-5 p-6">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50/80 p-4">
              ...
              <p className="mt-2 text-sm font-semibold text-slate-950">Meeting assistant intake</p>
            </div>
          </div>
